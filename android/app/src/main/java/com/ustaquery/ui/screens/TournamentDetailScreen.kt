...
import com.ustaquery.data.model.TournamentEntry
...
import com.ustaquery.viewmodel.DisplayRow
import com.ustaquery.viewmodel.TournamentDetailViewModel
                ...
                viewModel.tournament == null -> EmptyStateView(title = "Not found", description = "Tournament not found")
                    ...
                    Column(modifier = Modifier.fillMaxSize()) {
                        ...
                        Column(modifier = Modifier.verticalScroll(rememberScrollState()).padding(horizontal = 16.dp, vertical = 10.dp)) {
                            ...
                            // USTA link button
                            tournament.tournamentId?.let { tid ->
                                Spacer(Modifier.height(6.dp))
                                val slug = tournament.orgSlug ?: "abc"
                                val ustaUrl = "https://playtennis.usta.com/Competitions/$slug/Tournaments/Overview/$tid"
                                val context = LocalContext.current
                                TextButton(
                                    onClick = {
                                        val intent = android.content.Intent(android.content.Intent.ACTION_VIEW, android.net.Uri.parse(ustaUrl))
                                    ...
                                    Text("View on USTA", fontWeight = FontWeight.Medium)
                                }
                            }
                        }
